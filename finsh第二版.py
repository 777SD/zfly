...
def receive_data():
    ...
    while True:
        ...
        if date_read != 0:
            ...
            print(date_read)
            date_read =date_read.decode()
            lay=date_read                    #设置接收来判断运行某个text的条件
            #print(lay)
            # 清空接收缓冲区
            ser.flushInput()
            # 必要的软件延时
...
if cap.isOpened():
    while True:
        ...
        if text==5: #形况1识别三小料顺序
            ...
            if red or blue or green:  #红1 绿2 蓝3                   所以参数待修改
                if data[order4]=='1' and nember4==1 :
                    if max_area_red>=5000:
                        if  (2*x_red+w_red)/2 > center_x*0.8 and (2*x_red+w_red)/2 < center_x*1.2 :
                            if  (2*y_red+h_red)/2 > center_y*0.8 and (2*y_red+h_red)/2  < center_y*1.2 :    
                                ser.write(promise.encode()) 
                ...
                if data[order4]=='2' and nember4==1 :
                    if max_area_green>=5000:
                        if  (2*x_green+w_green)/2 > center_x*0.8 and (2*x_green+w_green)/2 < center_x*1.5 :
                            if  (2*y_green+h_green)/2 > center_y*0.8 and (2*y_green+h_green)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                if data[order4]=='3' and nember4==1 :
                    if max_area_blue>=5000:
                        if  (2*x_blue+w_blue)/2 > center_x*0.8 and (2*x_blue+w_blue)/2 < center_x*1.2 :
                            if  (2*y_blue+h_blue)/2 > center_y*0.8 and (2*y_blue+h_blue)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                #抓第二个                   #红1 绿2 蓝3 
                if data[order4]=='1' and nember4==2 :
                    if max_area_red>=5000:
                        if  (2*x_red+w_red)/2 > center_x*0.8 and (2*x_red+w_red)/2 < center_x*1.2 :
                            if  (2*y_red+h_red)/2 > center_y*0.8 and (2*y_red+h_red)/2  < center_y*1.2 :    
                                ser.write(promise.encode()) 
                ...
                if data[order4]=='2' and nember4==2 :
                    if max_area_green>=5000:
                        if  (2*x_green+w_green)/2 > center_x*0.8 and (2*x_green+w_green)/2 < center_x*1.2 :
                            if  (2*y_green+h_green)/2 > center_y*0.8 and (2*y_green+h_green)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                if data[order4]=='3' and nember4==2 :
                    if max_area_blue>=5000:
                        if  (2*x_blue+w_blue)/2 > center_x*0.8 and (2*x_blue+w_blue)/2 < center_x*1.2 :
                            if  (2*y_blue+h_blue)/2 > center_y*0.8 and (2*y_blue+h_blue)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                #抓第三个
                if data[order4]=='1' and nember4==3 :
                    if max_area_red>=5000:
                        if  (2*x_red+w_red)/2 > center_x*0.8 and (2*x_red+w_red)/2 < center_x*1.2 :
                            if  (2*y_red+h_red)/2 > center_y*0.8 and (2*y_red+h_red)/2  < center_y*1.2 :    
                                ser.write(promise.encode()) 
                ...
                if data[order4]=='2' and nember4==3 :
                    if max_area_green>=5000:
                        if  (2*x_green+w_green)/2 > center_x*0.8 and (2*x_green+w_green)/2 < center_x*1.5 :
                            if  (2*y_green+h_green)/2 > center_y*0.8 and (2*y_green+h_green)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                if data[order4]=='3' and nember4==3 :
                    if max_area_blue>=5000:
                        if  (2*x_blue+w_blue)/2 > center_x*0.8 and (2*x_blue+w_blue)/2 < center_x*1.2 :
                            if  (2*y_blue+h_blue)/2 > center_y*0.8 and (2*y_blue+h_blue)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
        ...
        if text==6: #扫描圆环
            ...
            #第一次放
            if data[order5]=='1' and nember5==1 :  #红1 绿2 蓝3   
                if  x_red > center_x*0.8 and x_red < center_x*1.2 : 
                    if y_red> center_y*0.8 and y_red <center_y*1.2:   
                        ser.write(put.encode()) 
                        order5+=1
            ...
            if data[order5]=='2' and nember5==1 :  #红1 绿2 蓝3   
                if  x_green > center_y*0.8 and x_green < center_y*1.2 :
                    if y_green > center_y*0.8 and y_green < center_y*1.2:   
                        ser.write(put.encode()) 
                        order5+=1
            ...
            if data[order5]=='3' and nember5==1 :  #红1 绿2 蓝3   
                if  x_blue > center_x*0.8 and x_blue < center_x*1.2 :
                    if  y_blue > center_y*0.8 and y_blue < center_y*1.2 :        
                        ser.write(put.encode()) 
                        order5+=1
            ...
            #第二次放
            if data[order5]=='1' and nember5==2 :  
                if  x_red > center_x*0.8 and x_red < center_x*1.2 : 
                    if y_red> center_y*0.8 and y_red <center_y*1.2:   
                        ser.write(put.encode()) 
                        order5+=1
            ...
            if data[order5]=='2' and nember5==2 :  
                if  x_green > center_x*0.8 and x_green < center_x*1.2 :
                    if y_green > center_y*0.8 and y_green < center_y*1.2:   
                        ser.write(put.encode()) 
                        order5+=1
            ...
            if data[order5]=='3' and nember5==2 :  
                if  x_blue > center_x*0.8 and x_blue < center_x*1.2 :
                    if  y_blue > center_y*0.8 and y_blue < center_y*1.2 :        
                        ser.write(put.encode()) 
                        order1+=1
            ...
            #第三次放
            if data[order5]=='1' and nember5==3 :  
                if  x_red > center_x*0.8 and x_red < center_x*1.2 : 
                    if y_red> center_y*0.8 and y_red <center_y*1.2:   
                        ser.write(put.encode()) 
                        order5+=1
            ...
            if data[order5]=='2' and nember5==3 :  
                if  x_green > center_x*0.8 and x_green < center_x*1.2 :
                    if y_green > center_y*0.8 and y_green < center_y*1.2:   
                        ser.write(put.encode()) 
                        order5+=1
            ...
            if data[order5]=='3' and nember5==3 :  
                if  x_blue > center_x*0.8 and x_blue < center_x*1.2 :
                    if  y_blue > center_y*0.8 and y_blue < center_y*1.2 :        
                        ser.write(put.encode()) 
                        order5+=1
        ...
        if text==7:   #第二次抓物料   按照从原料区运算的顺序来抓
            # 清理因为相同命名而可能出现的误差
            x_red, y_red, w_red, h_red=0,0,0,0
            x_blue, y_blue, w_blue, h_blue=0,0,0,0
            x_green, y_green, w_green, h_green=0,0,0,0
            ...
            if red or blue or green:  #红1 绿2 蓝3                   所以参数待修改
                ...
                if data[order6]=='1' and nember6==1 :
                    if max_area_red>=5000:
                        if  (2*x_red+w_red)/2 > center_x*0.8 and (2*x_red+w_red)/2 < center_x*1.2 :
                            if  (2*y_red+h_red)/2 > center_y*0.8 and (2*y_red+h_red)/2  < center_y*1.2 :    
                                ser.write(promise.encode()) 
                ...
                if data[order6]=='2' and nember6==1 :
                    if max_area_green>=5000:
                        if  (2*x_green+w_green)/2 > center_x*0.8 and (2*x_green+w_green)/2 < center_x*1.2 :
                            if  (2*y_green+h_green)/2 > center_y*0.8 and (y_green+h_green)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                if data[order6]=='3' and nember6==1 :
                    if max_area_blue>=5000:
                        if  (2*x_blue+w_blue)/2 > center_x*0.8 and (2*x_blue+w_blue)/2 < center_x*1.2 :
                            if  (2*y_blue+h_blue)/2 > center_y*0.8 and (2*y_blue+h_blue)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                #抓第二个
                if data[order6]=='1' and nember6==2 :
                    if max_area_red>=5000:
                        if  (2*x_red+w_red)/2 > center_x*0.8 and (2*x_red+w_red)/2 < center_x*1.2 :
                            if  (2*y_red+h_red)/2 > center_y*0.8 and (2*y_red+h_red)/2  < center_y*1.2 :    
                                ser.write(promise.encode()) 
                ...
                if data[order6]=='2' and nember6==2 :
                    if max_area_green>=5000:
                        if  (2*x_green+w_green)/2 > center_x*0.8 and (2*x_green+w_green)/2 < center_x*1.2 :
                            if  (2*y_green+h_green)/2 > center_y*0.8 and (y_green+h_green)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                if data[order6]=='3' and nember6==2 :
                    if max_area_blue>=5000:
                        if  (2*x_blue+w_blue)/2 > center_x*0.8 and (2*x_blue+w_blue)/2 < center_x*1.2 :
                            if  (2*y_blue+h_blue)/2 > center_y*0.8 and (2*y_blue+h_blue)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                #抓第三个
                if data[order6]=='1' and nember6==3 :
                    if max_area_red>=5000:
                        if  (2*x_red+w_red)/2 > center_x*0.8 and (2*x_red+w_red)/2 < center_x*1.2 :
                            if  (2*y_red+h_red)/2 > center_y*0.8 and (2*y_red+h_red)/2  < center_y*1.2 :    
                                ser.write(promise.encode()) 
                ...
                if data[order6]=='2' and nember6==3 :
                    if max_area_green>=5000:
                        if  (2*x_green+w_green)/2 > center_x*0.8 and (2*x_green+w_green)/2 < center_x*1.2 :
                            if  (2*y_green+h_green)/2 > center_y*0.8 and (y_green+h_green)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
                ...
                if data[order6]=='3' and nember6==3 :
                    if max_area_blue>=5000:
                        if  (2*x_blue+w_blue)/2 > center_x*0.8 and (2*x_blue+w_blue)/2 < center_x*1.2 :
                            if  (2*y_blue+h_blue)/2 > center_y*0.8 and (2*y_blue+h_blue)/2 < center_y*1.2 :  
                                ser.write(promise.encode()) 
        ...
        if text==8:  #第二次寻找圆环
            ...
            #第一次放
            if data[order7]=='1' and nember7==1 :  #红1 绿2 蓝3   
                if  x_red > center_x*0.8 and x_red < center_x*1.2 :
                    if y_red > center_y*0.8 and y_red <center_y*1.2:    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            if data[order7]=='2' and nember7==1 :  #红1 绿2 蓝3   
                if  x_green > center_x*0.8 and x_green < center_x*1.2 :
                    if y_green > center_y*0.8 and y_green <center_y*1.2 :    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            if data[order7]=='3' and nember7==1 :  #红1 绿2 蓝3   
                if  x_blue > center_x*0.8 and x_blue < center_x*1.2 :
                    if y_blue > center_y*0.8 and y_blue <center_y*1.2:    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            #第二次放
            if data[order7]=='1' and nember7==2 :  
                if  x_red > center_x*0.8 and x_red < center_x*1.2 :
                    if y_red > center_y*0.8 and y_red <center_y*1.2:    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            if data[order7]=='2' and nember7==2 :  
                if  x_green > center_x*0.8 and x_green < center_x*1.2 :
                    if y_green > center_y*0.8 and y_green <center_y*1.2 :    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            if data[order7]=='3' and nember7==2 :  
                if  x_blue > center_x*0.8 and x_blue < center_x*1.2 :
                    if y_blue > center_y*0.8 and y_blue <center_y*1.2:    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            #第三次放
            if data[order7]=='1' and nember7==3 :  
                if  x_red > center_x*0.8 and x_red < center_x*1.2 :
                    if y_red > center_y*0.8 and y_red <center_y*1.2:    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            if data[order7]=='2' and nember7==3 :  
                if  x_green > center_x*0.8 and x_green < center_x*1.2 :
                    if y_green > center_y*0.8 and y_green <center_y*1.2 :    
                        ser.write(put.encode()) 
                        order7+=1
            ...
            if data[order7]=='3' and nember7==3 :  
                if  x_blue > center_x*0.8 and x_blue < center_x*1.2 :
                    if y_blue > center_y*0.8 and y_blue <center_y*1.2:    
                        ser.write(put.encode()) 
                        order7+=1
